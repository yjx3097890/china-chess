========================================================================
		ActiveX Control DLL : XQWLIGHT
========================================================================

ControlWizard has created this project for your XQWLIGHT ActiveX Control
...
that make up your XQWLIGHT ActiveX Control DLL.
...
XQWLightCtl.h
	This file contains the declaration of the CXQWLightCtrl C++ class.

XQWLightCtl.cpp
	This file contains the implementation of the CXQWLightCtrl C++ class.

XQWLightPpg.h
	This file contains the declaration of the CXQWLightPropPage C++ class.

XQWLightPpg.cpp
	This file contains the implementation of the CXQWLightPropPage C++ class.

XQWLightCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CXQWLightCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file XQWLight.rc.
